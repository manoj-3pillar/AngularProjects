...
export class AddPropertyComponent implements OnInit {
 ...
 // @ViewChild('Form') addPropertyForm?: NgForm;
  ...
  //PType: Array<string> = ['House', 'Apartment', 'Duplex'];
  furnishTypes: Array<string> = ['Fully', 'Semi', 'UnFurnished'];
  cityList: Array<string> = ['Delhi', 'Mumbai', 'Patna'];
  ...
  mapProperty(): void {
    this.property.Id = this.housingService.getNewPropertyId();
  ...
  // check validation when save button directly clicked
